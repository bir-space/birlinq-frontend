...
/**
 * Mock counterpart of PublicScanPage: same orchestration, backed by
 * mock-endpoints instead of a live scan. Always resolves to the same
 * fixture vehicle regardless of the scanned code.
 */
